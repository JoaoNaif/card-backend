  ...
  const machineM1Characters = [
    {
      ...
      powerId: fire.id, skillIds: [fireBurst.id, infernalFury.id],
    ...
    },
    {
      ...
      powerId: gravity.id, skillIds: [vectorStrike.id, kineticShield.id],
    ...
    },
    {
      ...
      powerId: regeneration.id, skillIds: [adaptiveHeal.id, survivalInstinct.id],
    ...
    },
    {
      ...
      powerId: illusion.id, skillIds: [sensoryDistortion.id, mindVeil.id],
