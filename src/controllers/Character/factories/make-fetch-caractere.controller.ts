...
export function makeFetchCharacterController(): FetchCharacterController {
    ...
    const fetchCharacterUseCase = new FetchCharacterUseCase(characterRepository, powerRepository, userRepository);
    const fetchCharacterController = new FetchCharacterController(fetchCharacterUseCase);
